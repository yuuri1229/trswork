      ...
      >
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">合計 {formatMinutes(total)}</p>
          </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="ml-auto flex gap-2">
                      ...
                      <button onClick={saveEdit} className="text-xs font-semibold text-emerald-600">
                        保存
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      ...
                      {entry.synced && <span className="ml-1 text-emerald-500">・同期済</span>}
                    </p>
                  </div>
                  <div className="flex shrink-0 gap-2 text-xs">
                    <button onClick={() => startEdit(entry)} className="text-slate-400 hover:text-slate-600">
                      編集
                    </button>
                    <button onClick={() => onDelete(entry.id)} className="text-rose-400 hover:text-rose-600">
                      削除
                    </button>
                  </div>
                </div>
